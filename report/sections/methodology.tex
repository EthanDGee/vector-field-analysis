...
The grid is partitioned into cunks where each thread is assigned a contiguous range of rows.
...
We employ \texttt{\#pragma omp parallel for} directive with a \texttt{collapse(2)} clause to allow for easy segmenatation and load balancing across our nested loops.
